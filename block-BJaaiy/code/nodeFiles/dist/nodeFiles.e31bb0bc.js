...
console.log(day);
var MAYear = moment().format("MMMM Do YY");
console.log(MAYear); //stubtract///////////////////////
// add///

var addDays = moment().add(7, "days").calendar();
var addMonths = moment().add(7, "months").calendar();
var addYear = moment().add(7, "years").calendar();
console.log(addDays);
console.log(addMonths);
console.log(addYear); // subtract ///

var subtractsDays = moment().subtract(7, "days").calendar();
var subtractsMonths = moment().subtract(7, "months").calendar();
var subtractsYear = moment().subtract(7, "years").calendar();
console.log(subtractsDays);
console.log(subtractsMonths);
console.log(subtractsYear); // gap ////////////////////
...
//# sourceMappingURL=/nodeFiles.e31bb0bc.js.map